...
const Footer = () => {
  return (
    <motion.footer initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.5, delay:0.2}} style={bgImg} className='mt-16 h-[500px] bg-brandDark relative flex justify-center items-end'>
        <div
